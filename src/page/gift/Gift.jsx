    ...
    return (
        <>
            <Box sx={{ backgroundColor: "#ffc0b3", height: '25vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', gap: "10px" }}>
                ...
                <Typography sx={{ fontSize: "2rem", fontWeight: 700, color: "#DD404E" }}>Give a Pacific Adventures gift card</Typography>
                <Typography sx={{ fontSize: "18px", fontWeight: 500, color: "#707070", textAlign: 'center', width: '70%' }}>Give the ones you love unforgettable travel experiences and make memories to last a lifetime pacific-adventures on gift card</Typography>
            </Box>
